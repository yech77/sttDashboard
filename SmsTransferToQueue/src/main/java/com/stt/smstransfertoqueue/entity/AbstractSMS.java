 ...
 */
@MappedSuperclass
public class AbstractSMS implements Serializable{
    ...
    public String toString() {
        return "AbstractSMS{" + "id=" + id + ", systemId=" + systemId + ", messagesText=" + messagesText + ", messageType=" + messageType + ", date=" + date + ", iso2=" + iso2 + ", carrierCharCode=" + carrierCharCode + ", source=" + source + ", destination=" + destination + ", datacoding=" + datacoding + ", msgSended=" + msgSended + ", msgReceived=" + msgReceived + '}';
    }
