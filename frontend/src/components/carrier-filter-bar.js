...
class CarrierFilterBar extends PolymerElement {
    static get template() {
        return html`
            ...
            <div class="row">
                ...
                <vaadin-checkbox class="checkbox desktop" checked="{{checkboxChecked}}" on-focus="_onFieldFocus"
                                 on-blur="_onFieldBlur">[[checkboxText]]
                </vaadin-checkbox>
...
window.customElements.define(CarrierFilterBar.is, CarrierFilterBar);
