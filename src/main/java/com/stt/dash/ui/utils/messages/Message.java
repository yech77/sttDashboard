...
public class Message {
    ...
    public static final String CONFIRM_CAPTION_DELETE = "Confirmar Borrasr";
    ...
    public static final MessageSupplier UNSAVED_CHANGES = createMessage("Cambios Realizados", "Descartar", "Continue Editing",
            "Ha realizado modificaciones en the %s. ¿Descartar cambios?");
