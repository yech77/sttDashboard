...
public class ClientTrimestralPopUpView extends TrimestralSmsPopupView {
    ...
    public ClientTrimestralPopUpView(SmsHourService smsHourService, int yearSms, List<Integer> monthToShowList, List<String> systemidStringList) {
        presenter = new TrimestralSmsPopupPresenter(smsHourService, yearSms, monthToShowList, systemidStringList, this);
        createColumns(grid);
        grid.setHeight("75%");
        setTitles("Últimos tres meses", "Cliente");
