...
import com.stt.dash.ui.DailySmsShowGridPresenter;
...
public class ClientMonthlyPopupView extends MonthlySmsPopupView {

    public ClientMonthlyPopupView(SmsHourService smsHourService, int yearSms, int monthSms, List<String> systemidStringList, Set<OMessageType> messageType) {
    ...
    public ClientMonthlyPopupView(SmsHourService smsHourService, int yearSms, int monthSms, int daySms, List<String> systemidStringList, Set<OMessageType> messageType) {
