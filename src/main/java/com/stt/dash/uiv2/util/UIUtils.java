...
import com.stt.dash.uiv2.util.css.AlignSelf;
import com.stt.dash.uiv2.util.css.BorderRadius;
import com.stt.dash.uiv2.util.css.BoxSizing;
import com.stt.dash.uiv2.util.css.Overflow;
import com.stt.dash.uiv2.util.css.PointerEvents;
import com.stt.dash.uiv2.util.css.Shadow;
import com.stt.dash.uiv2.util.css.TextAlign;
import com.stt.dash.uiv2.util.css.TextOverflow;
import com.stt.dash.uiv2.util.css.WhiteSpace;
...
//    }
    ...
    public static String formatDate(Date date) {
        return dateFormat.get().format(date.toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
    }
