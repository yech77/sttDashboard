package com.stt.dash.uiv2.components.navigation.bar;

import com.stt.dash.uiv2.components.FlexBoxLayout;
import com.stt.dash.uiv2.components.navigation.tab.NaviTab;
import com.stt.dash.uiv2.components.navigation.tab.NaviTabs;
...
import static com.stt.dash.uiv2.util.UIUtils.IMG_PATH;
...
//        menuIcon.addClickListener(e -> MainLayout.get().getNaviDrawer().toggle());
    ...
    private void initAvatar() {
        ...
        contextMenu.addItem("Log Out", e -> VaadinSession.getCurrent().getSession().invalidate());
    }
